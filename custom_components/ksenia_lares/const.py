...
OUTPUT_TYPE_NOT_USED = "NOT_USED"
# Value sent to the panel to turn a (digital) output on. Analog outputs
# accept the full 0-255 range; we only do basic on/off control here.
OUTPUT_ON_VALUE = 255
OUTPUT_OFF_VALUE = 0
